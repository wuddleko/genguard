...
func TestPrintAsset(t *testing.T) {
	cases := []struct {
		...
		{"linux", "amd64", "", "genguard_0.6.0_linux_amd64.tar.gz"},
		{"linux", "arm64", "", "genguard_0.6.0_linux_arm64.tar.gz"},
		{"darwin", "amd64", "", "genguard_0.6.0_darwin_amd64.tar.gz"},
		{"darwin", "arm64", "", "genguard_0.6.0_darwin_arm64.tar.gz"},
		{"windows", "amd64", "", "genguard_0.6.0_windows_amd64.zip"},
